...
class MobileV1Controller extends BaseController
{
    ...
    public function syncEnrollments(Request $request)
    {
        ...
        $validated = $request->validate([
            ...
            'records.*.attachments' => ['nullable', 'array'],
            'records.*.attachments.*.id' => ['nullable', 'string', 'max:120'],
            'records.*.attachments.*.title' => ['nullable', 'string', 'max:255'],
            'records.*.attachments.*.kind' => ['nullable', 'string', 'max:40'],
            'records.*.attachments.*.uri' => ['nullable', 'string', 'max:2048'],
            'records.*.attachments.*.type' => ['nullable', 'string', 'max:120'],
            'records.*.attachments.*.status' => ['nullable', 'string', 'max:40'],
            'records.*.attachments.*.backend_id' => ['nullable', 'integer'],
            'records.*.attachments.*.error' => ['nullable', 'string', 'max:1000'],
            'records.*.field_conflicts' => ['nullable', 'array'],
            'records.*.field_conflicts.*.field' => ['nullable', 'string', 'max:120'],
            'records.*.field_conflicts.*.officerValue' => ['nullable'],
            'records.*.field_conflicts.*.verifiedValue' => ['nullable'],
            'records.*.field_conflicts.*.selected' => ['nullable', 'string', 'max:40'],
            'records.*.field_conflicts.*.reason' => ['nullable', 'string', 'max:1000'],
            'records.*.nin_policy' => ['nullable', 'array'],
            'records.*.nin_verified_values' => ['nullable', 'array'],
            'records.*.nin_verified_at' => ['nullable', 'date'],
            'records.*.nin_verification_provider' => ['nullable', 'string', 'max:255'],
            'records.*.nin_verification_error' => ['nullable', 'string', 'max:1000'],
            ...
            'records.*.location.mocked' => ['nullable', 'boolean'],
            'records.*.location.error' => ['nullable', 'string', 'max:500'],
            'records.*.location.capture_location' => ['nullable', 'array'],
            'records.*.location.submit_location' => ['nullable', 'array'],
            'records.*.location.capture_location.latitude' => ['nullable', 'numeric', 'between:-90,90'],
            'records.*.location.capture_location.longitude' => ['nullable', 'numeric', 'between:-180,180'],
            'records.*.location.capture_location.accuracy_meters' => ['nullable', 'numeric', 'min:0'],
            'records.*.location.capture_location.captured_at' => ['nullable', 'date'],
            'records.*.location.capture_location.source' => ['nullable', 'string', 'max:40'],
            'records.*.location.capture_location.mocked' => ['nullable', 'boolean'],
            'records.*.location.submit_location.latitude' => ['nullable', 'numeric', 'between:-90,90'],
            'records.*.location.submit_location.longitude' => ['nullable', 'numeric', 'between:-180,180'],
            'records.*.location.submit_location.accuracy_meters' => ['nullable', 'numeric', 'min:0'],
            'records.*.location.submit_location.captured_at' => ['nullable', 'date'],
            'records.*.location.submit_location.source' => ['nullable', 'string', 'max:40'],
            'records.*.location.submit_location.mocked' => ['nullable', 'boolean'],
            'app_version' => ['nullable', 'string', 'max:40'],
            'gps' => ['nullable', 'array'],
        ]);
