...
class EnrollmentFormSchemaService
{
    ...
    public function defaultFields(): array
    {
        return [
            ...
            ['key' => 'community', 'label' => 'Community', 'type' => 'text', 'required' => false, 'rules' => ['string', 'max:255']],
            ...
            ['key' => 'educational_status', 'label' => 'Educational status', 'type' => 'select', 'required' => false, 'rules' => ['string', 'max:255'], 'options' => $this->stringSelectOptions(Enrollee::EDUCATIONAL_STATUS_OPTIONS)],
            ['key' => 'disability', 'label' => 'Special Needs', 'type' => 'select', 'required' => false, 'rules' => ['string', 'max:255'], 'options' => $this->stringSelectOptions(Enrollee::DISABILITY_OPTIONS)],
