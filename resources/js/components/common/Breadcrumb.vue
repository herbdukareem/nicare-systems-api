...
const breadcrumbMappings = {
  ...
  '/enrollees/duplicate-nin-verification': [{ name: 'Enrollment', path: '/enrollees' }, { name: 'Duplicate NIN Verification' }],
  ...
  '/settings/organization': [{ name: 'Settings' }, { name: 'Organization Settings' }],
