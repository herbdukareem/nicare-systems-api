export const navigationItems = [
  ...
  },
  {
    ...
    children: [
      ...
      { name: 'NIN & Duplicates', path: '/enrollees/integrity', icon: 'mdi-shield-account-outline', permissions: ['enrollees.update', 'enrollee.approve', 'enrollee.nin.verify', 'enrollee.status.change'] },
      { name: 'Duplicate NIN Verify', path: '/enrollees/duplicate-nin-verification', icon: 'mdi-card-account-details-star-outline', permissions: ['enrollees.update', 'enrollee.approve', 'enrollee.nin.verify'] },
      { name: 'Enrollment Intelligence', path: '/enrollment/intelligence', icon: 'mdi-chart-box-outline', permissions: ['enrollee.nin.verify', 'reports.view'] },
      { name: 'Demo Enrollment', path: '/enrollees/demo-enrollment', icon: 'mdi-account-plus-outline', permissions: ['enrollees.create'] },
      { name: 'Enrollment Slips', path: '/enrollees/bulk-enrollment-slip', icon: 'mdi-file-document-multiple-outline', permissions: ['enrollee.print-bulk-slip'] },
  ...
  },
  {
    ...
    children: [
      ...
      { name: 'Payment Report', path: '/capitation/reports', icon: 'mdi-file-chart-outline', permissions: ['capitation.payment-report.view'] },
      { name: 'Enrollee List', path: '/capitation/enrollee-list', icon: 'mdi-account-multiple-outline', permissions: ['capitation.enrollee-list.view'] },
    ],
  },
  {
    name: 'Payments',
  ...
  },
  {
    ...
    children: [
      { name: 'Reports', path: '/reports', icon: 'mdi-file-chart-outline', permissions: ['reports.view', 'reports.generate'] },
      { name: 'Financial', path: '/reports/financial', icon: 'mdi-finance', permissions: ['reports.financial', 'reports.executive', 'reports.view'] },
      { name: 'Analytics', path: '/analytics', icon: 'mdi-chart-line', permissions: ['analytics.view'] },
  ...
  },
  {
    ...
    children: [
      ...
      { name: 'Payment Gateway', path: '/settings/payment-gateways', icon: 'mdi-credit-card-settings-outline', permissions: ['settings.payment-gateway.manage', 'settings.edit'] },
      { name: 'Virtual Accounts', path: '/settings/payment-collections', icon: 'mdi-bank-transfer-in', permissions: ['settings.payment-collection.manage', 'settings.edit'] },
