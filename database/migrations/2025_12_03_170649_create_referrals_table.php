...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('referrals', function (Blueprint $table) {
            ...
            // --- FIX: Columns moved sequentially ---
            $table->boolean('utn_validated')->default(false);
            $table->timestamp('utn_validated_at')->nullable();
            $table->foreignId('utn_validated_by')->nullable()->constrained('users')->onDelete('set null');
            // ----------------------------------------
