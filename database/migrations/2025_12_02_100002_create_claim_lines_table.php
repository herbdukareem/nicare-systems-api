...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('claim_lines', function (Blueprint $table) {
            ...
            $table->foreignId('case_record_id')->constrained('cases')->onDelete('restrict'); // Link to the service/tariff item
            ...
            $table->string('reported_diagnosis_code')->after('line_total')->nullable();
