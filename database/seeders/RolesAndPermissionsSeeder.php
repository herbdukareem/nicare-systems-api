    ...
    public function run(): void
    {
        ...
        $permissionsByCategory = [
            ...
            'Capitation & Payments' => [
                ...
                'capitation.finalise',
                'capitation.export',
                'capitation.payment-report.view',
                'capitation.enrollee-list.view',
                'payments.view',
                'payments.create',
                'payments.process',
                'payments.finalise',
            ...
            'Administration' => [
                ...
                'settings.payment-collection.manage',
                'payment.collection.review',
                'payment.collection.settle-manually',
        ...
        $roles = [
            ...
            'scheme-admin' => [
                ...
                ]), ['settings.nin.manage', 'settings.payment-gateway.manage', 'settings.organization.manage', 'settings.enrollment-schema.manage', 'settings.mobile-device.manage']))),
            ],
            'enrollment-officer' => [
            ...
            'finance-officer' => [
                ...
                'permissions' => [
                    ...
                    'capitation.finalise', 'capitation.export', 'capitation.payment-report.view',
                    'capitation.enrollee-list.view',
                    'reports.financial', 'claims.view',
                ],
            ],
            'tariff_manager' => [
